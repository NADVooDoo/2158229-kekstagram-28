# Личный проект «Кекстаграм», выполненный во время обучения в HTML Academy на «Профессии фронтенд-разработчик» по модулю «JavaScript. Профессиональная разработка веб-интерфейсов».
